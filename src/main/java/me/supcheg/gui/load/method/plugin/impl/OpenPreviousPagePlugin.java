...
public class OpenPreviousPagePlugin extends MethodPlugin {
    public OpenPreviousPagePlugin(@NotNull Annotation annotation) {
        super(annotation);
    }
    ...
    public boolean run(@NotNull Object guiInstance, @NotNull ArgumentsResolver argumentsResolver) {
        ...
        return guiContainer.openPreviousPage(player);
    }
}
